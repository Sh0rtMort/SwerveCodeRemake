...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final class Mod3 { //TODO: This must be tuned to specific robot
            public static final int driveMotorID = 46; //CAN ID for the drive motor NEEDS TO BE FIXED
            public static final int angleMotorID = 45; //CAN ID for the angle/steerer motor NEEDS TO BE FIXED
